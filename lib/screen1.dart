                      ...
                      child: Row(
                        children: <Widget>[
                          IconButton(
                            ...
                            onPressed: Provider.of<GeneralProvider>(context,
                                    listen: false)
                                .toggleIcons,
                          ),
                          // IconButton(
                          ...
                          Visibility(
                            visible:
                                Provider.of<GeneralProvider>(context).showIcons,
                            child: Row(
                              children: [
                                IconButton(
                                    onPressed: () {
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 165,
                            decoration: BoxDecoration(
                                color: Color.fromARGB(255, 122, 154, 184),
                                borderRadius: BorderRadius.circular(30),
                                // border: Border.all(width: 1),
                                image: DecorationImage(
                                    image: AssetImage(
                                        'asset/images/output-onlinegiftools (3).gif'))),
                          ),
                        ),
                        Container(
                          height: 40,
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 165,
                            decoration: BoxDecoration(
                                color: Color.fromARGB(232, 186, 190, 121),
                                borderRadius: BorderRadius.circular(30),
                                // border: Border.all(
                                //   width: 1,
                                // ),
                                image: DecorationImage(
                                    image: AssetImage(
                                        'asset/images/output-onlinegiftools (4).gif'))),
                          ),
                        ),
                        Container(
                          height: 40,
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 165,
                            decoration: BoxDecoration(
                                color: Color.fromARGB(255, 219, 178, 219),
                                borderRadius: BorderRadius.circular(30),
                                // border: Border.all(width: 1),
                                image: DecorationImage(
                                    image: AssetImage(
                                        'asset/images/output-onlinegiftools (2).gif'))),
                          ),
                        ),
                        Container(
                          height: 40,
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Container(
                            ...
                            width: 165,
                            decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 212, 166, 152),
                                borderRadius: BorderRadius.circular(30),
                                // border: Border.all(width: 1),
                                image: DecorationImage(
                                    image: AssetImage(
                                        'asset/images/output-onlinegiftools (5).gif'))),
                          ),
                        ),
                        Container(
                          height: 40,
